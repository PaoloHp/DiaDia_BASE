...
import it.uniroma3.diadia.interfacce.InterfacciaUtente;
import it.uniroma3.diadia.interfacce.InterfacciaUtenteConsole;
...
public class DiaDia {
	...
	public static void setElencoComandi(String[] elencoComandi) {
		DiaDia.elencoComandi = elencoComandi;
	}

	public DiaDia() throws FileNotFoundException, FormatoFileNonValidoException {
    	this.partita = new Partita("DiaDia");
